    ...
    <div class="container" style="margin-top: 150px; margin-bottom: 100px;">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <form action="${contextPath}/GestionRecruiters?action=update" method="post">
                            <h1 class="text-center" style="color: #012970;">Update Recruiter Information</h1> <br>
                            <input type="hidden" class="form-control" name="id_recruiter" id="id_recruiter" value="${loggedInRecruiter.id_recruiter}">
                            
                            <div class="form-group">
                                <label for="name" style="color: #012970; border-color: #012970; font-weight:bold;">Name</label>
                                <input type="text" class="form-control" name="name" id="name" value="${loggedInRecruiter.name}" required>
                            </div><br>
                            
                            <div class="form-group" style="color: #012970; border-color: #012970; font-weight:bold;">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" name="email" id="email" value="${loggedInRecruiter.email}" required>
                            </div><br>
                            
                            <div class="form-group">
                                <label for="company" style="color: #012970; border-color: #012970; font-weight:bold;">Company</label>
                                <input type="text" class="form-control" name="company" id="company" value="${loggedInRecruiter.company}" required>
                            </div><br>
                            
                            <div class="form-group">
                                <label for="description" style="color: #012970; border-color: #012970; font-weight:bold;">Description</label>
                                <textarea class="form-control" name="description" id="description" style="height: 150px;" required>${loggedInRecruiter.description}</textarea>
                            </div><br>
                            
                            <div class="form-group">
                                <label for="address" style="color: #012970; border-color: #012970; font-weight:bold;">Address</label>
                                <input type="text" class="form-control" name="address" id="address" value="${loggedInRecruiter.address}" required>
                            </div><br>
                            
                            <div class="form-group">
                                <label for="city" style="color: #012970; border-color: #012970; font-weight:bold;">City</label>
                                <input type="text" class="form-control" name="city" id="city" value="${loggedInRecruiter.city}" required>
                            </div><br>
                            
                            <div class="form-group">
                                <label for="country" style="color: #012970; border-color: #012970; font-weight:bold;">Country</label>
                                <input type="text" class="form-control" name="country" id="country" value="${loggedInRecruiter.country}" required>
                            </div><br>
